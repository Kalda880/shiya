...
<div class="modal-container"  id="signup-modal">
    ...
    <div class="modal signUp ">
        ...
        <div class="modal-title">
            <h2>  حساب جديد </h2>
            <p>مرحباً بك في شـيـة ،   يرجي تسجيل البيانات المطلوبة لانشاء حسابك   efferreerg           </p>
        </div>
        <form class="sign-up-form" method="POST" action="{{ myRoute('register') }}">
            @csrf
            ...
            <button type="submit" class="submit-btn">  dededde حساب</button>
        </form>
