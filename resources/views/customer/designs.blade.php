    ...
    <div class="pages">
        ...
        <div class="projects " data-page="projects">
            ...
            <div class="cardd col-lg-3 col-md-12 col-sm-12 col-12">
                ...
                <a href="{{ designLink($item->design_id) }}">

                <div style="width: 100%;" class="card-img">
                    <img style="width: 100%; height: 100%;" src="{{   designImage($item->design->images)    }}" alt="">
                    <div class="edit-badge">

                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="19.5" height="5.5"
                ...
                <div class="card-cat">   {{ $item->design->category->title }}</div>
