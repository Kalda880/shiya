    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12">
            ...
            <div class="intro-y box p-5">
                ...
                <form method="POST" action="{{ myRoute('dashboard.roles.update', $role->id ) }}" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    <label for="crud-form-1" class="form-label"> اسم الصلاحية  </label>
                    <input id="crud-form-1" type="text" class="form-control w-full" name="name" required value="{{ $role->name }}">
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-switch mt-2">
                                    ...
                                    {{ $role->hasPermission($permission . '-' .  $map) ? 'checked' : '' }}
                                     value="{{ $permission . '-' .  $map }}"  class="form-check-input" data-color="#039cfd"/>
