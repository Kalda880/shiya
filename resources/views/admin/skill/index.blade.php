    ...
    <div class="grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="col-span-12 2xl:col-span-3">
            <div class="box intro-y p-5 mt-5">
                ...
                <form method="POST" action="{{ myRoute('dashboard.skill.store') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="mt-3">
                        <label for="crud-form-1" class="form-label">عنوان المهارة</label>
                        <input id="crud-form-1" type="text" name="title" value="{{ old('title') }}" class="form-control w-full" placeholder="عنوان المهارة">
                    </div>
            ...
            <tr class="intro-x text-center">
                ...
                <td class="table-report__action w-56">
                    <div class="flex justify-center items-center">
                        <a class="flex items-center mr-3" href="{{ myRoute('dashboard.skill.edit', $order->id) }}"> 
                            <i data-lucide="check-square" class="w-4 h-4 mr-1 ml-1"></i> تعديل </a>
                        <a class="flex items-center text-danger delete" href="javascript:;" data-href="{{ myRoute('dashboard.skill.destroy', $order->id) }}">
