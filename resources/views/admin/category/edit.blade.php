...
<div class="content">
    ...
    <form method="POST" action="{{ myRoute('dashboard.category.update', $category->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                ...
                <div class="mt-3">
                    ...
                    <input id="crud-form-1" type="text" required name="title" value="{{  old('title',$category->title) }}" class="form-control w-full" placeholder="عنوان القسم">
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input id="crud-form-cat-order" type="text" name="cat_order" value="{{ old('cat_order',$category->cat_order) }}" class="form-control w-full" placeholder="ترتيب القسم">
                </div>
                <div class="mt-3">
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ms-auto mt-3 sm:mt-0">
                        <input @if (old('is_active',$category->is_active)) checked @endif id="is_active"  name="is_active"  class="form-check-input me-0 ms-3" type="checkbox">
                        </div>
                </div>
