...
<div id="{{$id_modal}}" class="modal" modal-type="confirm" tabindex="-1" aria-hidden="true">
    ...
    <div class="text-slate-500 mt-2">{{trans("messages.Do you really want to decline this payment request")}} </div>
    ...
    <div >
        <label >السبب</label>
        <input class="form-control py-3 px-4 block" placeholder="السبب" name="cause" type="text" required />
    </div>
    </form>
</div>
