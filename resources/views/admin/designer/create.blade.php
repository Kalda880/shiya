...
<div class="content">
    ...
    <form method="POST" action="{{ myRoute('dashboard.designer.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                ...
                <div class="text-right mt-5">
                    <a href="{{ myRoute('dashboard.designer.index') }}" type="button" class="btn btn-outline-secondary w-24 mr-1">الغاء</a>
