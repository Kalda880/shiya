<div class="modal  fade " id="create-new-pass" tabindex="-1" aria-labelledby="create-new-pass" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-3">
            <div class=" passowrd-form ">
                ...
                <form class="passowrd-form">
                    ...
                    <button type="submit" class="submit-btn"> إن حساب</button>
                </form>
            </div>
        </div>
    </div>
